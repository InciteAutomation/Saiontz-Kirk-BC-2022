query 50121 "Escrow G/L Entries"
{
    Caption = 'G/L Entries';
    ...
    column(Additional_Currency_Amount;
    "Additional-Currency Amount")
    {
    }
    column(Add_Currency_Debit_Amount;
    "Add.-Currency Debit Amount")
    {
    }
    column(Add_Currency_Credit_Amount;
    ...
    column(Transaction_No_;
    "Transaction No.")
    {
    }
    column(FileVine_Project_ID;
    "FileVine Project ID")
    {
    }
    }
