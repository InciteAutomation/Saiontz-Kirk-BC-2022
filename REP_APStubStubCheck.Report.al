report 50103 REP_APStubStubCheck
{
    CaptionML = ENU='AP Stub/Stub/Check Layout';
    RDLCLayout = 'ReportLayouts/APStubStubCheck.rdl';
    WordLayout = 'ReportLayouts/APStubStubCheck.docx';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine;"Gen. Journal Line")
        {
            ...
            //JHIII //FIXME added from extension
            //TODO add variable and arrays similar to shortcut_dimension code for....
            //reference, "due date",
            // account
            column(tablixAccount;APAccount)
            {
            }
            column(tablixResource;VendInvNo)
            {
            }
            column(Account_1;"APAccountTable"[1])
            {
            }
            column(Account_2;"APAccountTable"[2])
            {
            }
            column(Account_3;"APAccountTable"[3])
            {
            }
            column(Account_4;"APAccountTable"[4])
            {
            }
            column(Account_5;"APAccountTable"[5])
            {
            }
            column(Account_6;"APAccountTable"[6])
            {
            }
            column(Account_7;"APAccountTable"[7])
            {
            }
            column(Account_8;"APAccountTable"[8])
            {
            }
            column(Account_9;"APAccountTable"[9])
            {
            }
            column(Account_10;"APAccountTable"[10])
            {
            }
            column(Reference_1;"VendInvNoTable"[1])
            {
            }
            column(Reference_2;"VendInvNoTable"[2])
            {
            }
            column(Reference_3;"VendInvNoTable"[3])
            {
            }
            column(Reference_4;"VendInvNoTable"[4])
            {
            }
            column(Reference_5;"VendInvNoTable"[5])
            {
            }
            column(Reference_6;"VendInvNoTable"[6])
            {
            }
            column(Reference_7;"VendInvNoTable"[7])
            {
            }
            column(Reference_8;"VendInvNoTable"[8])
            {
            }
            column(Reference_9;"VendInvNoTable"[9])
            {
            }
            column(Reference_10;"VendInvNoTable"[10])
            {
            }
            // column(Memo_1; "MemoTable"[1]) { }
            // column(Memo_2; "MemoTable"[2]) { }
            // column(Memo_3; "MemoTable"[3]) { }
            // column(Memo_4; "MemoTable"[4]) { }
            // column(Memo_5; "MemoTable"[5]) { }
            // column(Memo_6; "MemoTable"[6]) { }
            // column(Memo_7; "MemoTable"[7]) { }
            // column(Memo_8; "MemoTable"[8]) { }
            // column(Memo_9; "MemoTable"[9]) { }
            // column(Memo_10; "MemoTable"[10]) { }
            column(Memo;"Deposit Detail")
            {
            }
            column("DueDate";"Due Date")
            {
            }
            column(AccountNo;BalancingNo)
            {
            }
            ...
            column("Balance_Description";"Balance Description")
            {
            }
            // column("Shortcut_Dimension_Code_1_"; "ShortcutDimensionCode"[1]) { }
            // column("Shortcut_Dimension_Code_Real"; "ShortcutDimensionCodeTable") { }
            // column("Shortcut_Dimension_Code_2_"; "ShortcutDimensionCode"[2]) { }
            // column("Shortcut_Dimension_Code_3_"; "ShortcutDimensionCode"[3]) { }
            // column("Shortcut_Dimension_Code_4_"; "ShortcutDimensionCode"[4]) { }
            // column("Shortcut_Dimension_Code_5_"; "ShortcutDimensionCode"[5]) { }
            // column("Shortcut_Dimension_Code_6_"; "ShortcutDimensionCode"[6]) { }
            // column("Shortcut_Dimension_Code_7_"; "ShortcutDimensionCode"[7]) { }
            // column("Shortcut_Dimension_Code_8_"; "ShortcutDimensionCode"[8]) { }
            // column("Shortcut_Dimension_Code_9_"; "ShortcutDimensionCode"[9]) { }
            // column("Shortcut_Dimension_Code_10_"; "ShortcutDimensionCode"[10]) { }
            column("AccountNo_1";AccountNoArr[1])
            {
            }
            column("AccountNo_2";AccountNoArr[2])
            {
            }
            column("AccountNo_3";AccountNoArr[3])
            {
            }
            column("AccountNo_4";AccountNoArr[4])
            {
            }
            column("AccountNo_5";AccountNoArr[5])
            {
            }
            column("AccountNo_6";AccountNoArr[6])
            {
            }
            column("AccountNo_7";AccountNoArr[7])
            {
            }
            column("AccountNo_8";AccountNoArr[8])
            {
            }
            column("AccountNo_9";AccountNoArr[9])
            {
            }
            column("AccountNo_10";AccountNoArr[10])
            {
            }
            column("Memo_1";PaymentReferenceArr[1])
            {
            }
            column("Memo_2";PaymentReferenceArr[2])
            {
            }
            column("Memo_3";PaymentReferenceArr[3])
            {
            }
            column("Memo_4";PaymentReferenceArr[4])
            {
            }
            column("Memo_5";PaymentReferenceArr[5])
            {
            }
            column("Memo_6";PaymentReferenceArr[6])
            {
            }
            column("Memo_7";PaymentReferenceArr[7])
            {
            }
            column("Memo_8";PaymentReferenceArr[8])
            {
            }
            column("Memo_9";PaymentReferenceArr[9])
            {
            }
            column("Memo_10";PaymentReferenceArr[10])
            {
            }
            column("PaymentReferenceTablix";"Payment Reference")
            {
            }
            column("DueDate_1";DueDateArray[1])
            {
            }
            column("DueDate_2";DueDateArray[2])
            {
            }
            column("DueDate_3";DueDateArray[3])
            {
            }
            column("DueDate_4";DueDateArray[4])
            {
            }
            column("DueDate_5";DueDateArray[5])
            {
            }
            column("DueDate_6";DueDateArray[6])
            {
            }
            column("DueDate_7";DueDateArray[7])
            {
            }
            column("DueDate_8";DueDateArray[8])
            {
            }
            column("DueDate_9";DueDateArray[9])
            {
            }
            column("DueDate_10";DueDateArray[10])
            {
            }
            ...
            dataitem(CheckPages;"Integer")
            {
                ...
                dataitem(PrintSettledLoop;"Integer")
                {
                    ...
                    trigger OnAfterGetRecord()begin
                        //TODO JHIII try declare here 
                        //PaymentReference := GenJnlLine."Payment Reference";
                        DueDatePlaceholder:=GenJnlLine."Due Date";
                        // ShortcutDimensionCodeTable := GenJnlLine."Shortcut Dimension 2 Code";
                        // ShortcutDimensionCode[1] := GenJnlLine."Shortcut Dimension 2 Code";
                        AccountNoPlaceholder:=GenJnlLine."Account No.";
                        GnJnlLineDocNo:=GenJnlLine."Document No.";
                        VendLedgRef.SetFilter("Applies-to ID", GenJnlLine."Applies-to ID");
                        VendLedgRef.SetFilter("External Document No.", GenJnlLine."Applies-to Ext. Doc. No.");
                        VendLedgRef.FindLast();
                        PurchLineRef.SetFilter("Document No.", VendLedgRef."Document No.");
                        PurchLineRef.SetFilter("Buy-from Vendor No.", VendLedgRef."Vendor No.");
                        PurchLineRef.FindLast();
                        PurchHeaderRef.SetFilter("No.", VendLedgRef."Document No.");
                        VendInvNo:=GenJnlLine."Applies-to Ext. Doc. No."; //PurchHeaderRef."Vendor Invoice No.";
                        //message('This is the VendInvNo ' + VendInvNo);
                        APAccount:=PurchLineRef."No." + '-' + PurchLineRef.Description;
                        //APAccount := GenJnlLine."G/L Account No." + '-' + GenJnlLine."G/L Account Name";
                        // message('General Journal Line Reference ' + GenJnlLine."Payment Reference");
                        PaymentReference:=GenJnlLine."Payment Reference";
                        //PaymentReference := GenJnlLine2."Payment Reference";
                        if not TestPrint then begin
                            if FoundLast or not AddedRemainingAmount then begin
                                if RemainingAmount <> 0 then begin
                                    ...
                                    DueDatePlaceholder:=GenJnlLine."Due Date";
                                    APAccount:=PurchLineRef."No." + '-' + PurchLineRef.Description;
                                    VendInvNo:=GenJnlLine."Applies-to Ext. Doc. No.";
                                    PaymentReference:=GenJnlLine."Payment Reference";
                                    AccountNoPlaceholder:=GenJnlLine."Account No.";
                                end
                                else
                                ...
                                ApplyMethod::MoreLinesOneEntry: begin
                                    ...
                                    VendInvNo:=GenJnlLine2."Applies-to Ext. Doc. No.";
                                    if GenJnlLine2."Applies-to Doc. No." = '' then begin
                                        ...
                                        // ShortcutDimensionCodeTable := GenJnlLine2."Shortcut Dimension 2 Code";
                                        DueDatePlaceholder:=GenJnlLine2."Due Date";
                                        AccountNoPlaceholder:=GenJnlLine2."Account No.";
                                        VendLedgRef.SetFilter("Applies-to ID", GenJnlLine2."Applies-to ID");
                                        VendLedgRef.SetFilter("External Document No.", GenJnlLine2."Applies-to Ext. Doc. No.");
                                        VendLedgRef.FindLast();
                                        PurchLineRef.SetFilter("Document No.", VendLedgRef."Document No.");
                                        PurchLineRef.SetFilter("Buy-from Vendor No.", VendLedgRef."Vendor No.");
                                        PurchLineRef.FindLast();
                                        //APAccount := GenJnlLine2."G/L Account No." + '-' + GenJnlLine2."G/L Account Name";
                                        APAccount:=PurchLineRef."No." + '-' + PurchLineRef.Description;
                                    //PaymentReference := GenJnlLine2."Payment Reference";
                                    end
                                    else
                        ...
                        begin
                            ...
                            LineDiscount:=0;
                            PostingDesc:='';
                            // ShortcutDimensionCodeTable := '';
                            PaymentReference:='';
                            AccountNoPlaceholder:='';
                            DueDatePlaceholder:=0D;
                            VendInvNo:='';
                            APAccount:='';
                        end;
                        ...
                        PaymentReferenceArr[Stub2LineNo]:=PaymentReference;
                        AccountNoArr[Stub2LineNo]:=AccountNoPlaceholder;
                        DueDateArray[Stub2LineNo]:=DueDatePlaceholder;
                        Stub2LineAmount[Stub2LineNo]:=LineAmount;
                        //Message('Hello from Stub Stub Check! This is Stub2LineAmount[ ' + Format(Stub2LineNo) + ' ]:' + Format(LineAmount));
                        Stub2LineDiscount[Stub2LineNo]:=LineDiscount;
                        // ShortcutDimensionCode[Stub2LineNo] := ShortcutDimensionCodeTable;
                        APAccountTable[Stub2LineNo]:=APAccount;
                        VendInvNoTable[Stub2LineNo]:=VendInvNo;
                        MemoTable[Stub2LineNo]:=GenJnlLine."Deposit Detail";
                        Stub2PostingDescription[Stub2LineNo]:=PostingDesc;
                    //Message('This is the Referebce ' + format(Stub2LineNo) + ' ' + VendInvNo);
                    end;
                    trigger OnPreDataItem()begin
                ...
                dataitem(PrintCheck;"Integer")
                {
                    ...
                    column(VendorVendNo;VendorVenderNo)
                    {
                    }
                    ...
                    column(CheckAmountTextFooter;TotalLineAmount)
                    {
                    }
                    ...
                    trigger OnAfterGetRecord()var CurrencySymbol: Code[5];
                    begin
                ...
                trigger OnAfterGetRecord()begin
                    ...
                    Clear(Stub2DocDate);
                    Clear(AccountNoArr);
                    Clear(PaymentReferenceArr);
                    Clear(DueDateArray);
                    Clear(Stub2LineAmount);
                    Clear(Stub2LineDiscount);
                    Clear(Stub2PostingDescription);
                    Clear(VendInvNoTable);
                    //Clear(LineAmount);
                    Clear(APAccountTable);
                    // Clear(ShortcutDimensionCode);
                    Stub2DocNoHeader:='';
                    Stub2DocDateHeader:='';
                    Stub2AmountHeader:='';
                    Stub2DiscountHeader:='';
                ...
                trigger OnPostDataItem()var RecordRestrictionMgt: Codeunit "Record Restriction Mgt.";
                begin
                    if not TestPrint then begin
            ...
            trigger OnAfterGetRecord()begin
                ...
                if not TestPrint then begin
                    ...
                    if("Account No." <> '') and ("Bal. Account No." <> '')then begin
                        ...
                        //Message('This is the Balancing Type ' + Format(BalancingType) + ' and this is the Balancing No ' + BalancingNo);
            ...
            trigger OnPreDataItem()var CompanyInfo: Record "Company Information";
            begin
                Copy(VoidGenJnlLine);
                CompanyInfo.Get;
                if not TestPrint then begin
    ...
    AccountNoArr: array[50]of Code[20];
    AccountNoPlaceholder: Code[2048];
    PaymentReferenceArr: array[50]of Code[2048];
    PaymentReference: Code[2048];
    DueDateArray: array[50]of Date;
    DueDatePlaceholder: Date;
    ShortcutDimensionCode: array[50]of Text[100];
    ShortcutDimensionCodeTable: Text[100];
    ...
    StartingLen: Integer;
    //TODO add vednor ledger entries Document No. Vendor No.
    //add Purchase header--Vendor Invoice No.
    //addPurch. Inv. Line No. Description
    VendLedgRef: Record "Vendor Ledger Entry";
    PurchLineRef: Record "Purch. Inv. Line";
    PurchHeaderRef: Record "Purch. Inv. Header";
    GnJnlLineDocNo: Code[100];
    VendorDocNo: Code[100];
    VendorVenderNo: Code[100];
    PurchHeadVendInvNo: Code[100];
    PurchIvnLineNo: Code[100];
    PurchInvDesc: Code[100];
    APAccount: Code[200];
    VendInvNo: Code[200];
    APAccountTable: array[100]of Code[200];
    VendInvNoTable: array[100]of Code[200];
    MemoTable: array[100]of Text[500];
    ControlLen: Integer;
    NewLen: Integer;
    ...
    RemainingAmount2: Decimal)begin
        ...
        // ShortcutDimensionCodeTable := CustLedgEntry2."Global Dimension 2 Code";
        DueDatePlaceholder:=CustLedgEntry2."Due Date";
        VendInvNo:=ExtDocNo; //CustLedgEntry2."Applies-to Ext. Doc. No.";
        PaymentReference:=CustLedgEntry2."Payment Reference";
        //APAccount := CustLedgEntry2.no + '-' + GenJnlLine."G/L Account Name";
    ...
    RemainingAmount2: Decimal)begin
        ...
        // ShortcutDimensionCodeTable := VendLedgEntry2."Global Dimension 2 Code";
        DueDatePlaceholder:=VendLedgEntry2."Due Date";
        VendInvNo:=VendLedgEntry2."External Document No.";
        PaymentReference:=VendLedgEntry2."Payment Reference";
        VendLedgRef.SetFilter("Applies-to ID", VendLedgEntry2."Applies-to ID");
        VendLedgRef.SetFilter("External Document No.", VendLedgEntry2."Applies-to Ext. Doc. No.");
        VendLedgRef.FindLast();
        PurchLineRef.SetFilter("Document No.", VendLedgRef."Document No.");
        PurchLineRef.SetFilter("Buy-from Vendor No.", VendLedgRef."Vendor No.");
        PurchLineRef.FindLast();
    ...
    RemainingAmount2: Decimal)begin
        ...
        // ShortcutDimensionCodeTable := EmployeeLedgerEntry2."Global Dimension 2 Code";
    ...
    NewPreprintedStub: Boolean)begin
    ...
    CurrencyCode2: Code[10];
    Amount: Decimal)Amount2: Decimal begin
    ...
    local procedure CheckGenJournalBatchAndLineIsApproved(GenJournalLine: Record "Gen. Journal Line"): Boolean var GenJournalBatch: Record "Gen. Journal Batch";
    begin
    ...
    local procedure VerifyRecordIdIsApproved(RecordID: RecordID): Boolean var ApprovalEntry: Record "Approval Entry";
    begin
    ...
    local procedure PrintOneLineOneEntryOnAfterGetRecordForCustomer(var CustLedgEntry1: Record "Cust. Ledger Entry")begin
    ...
    local procedure PrintOneLineOneEntryOnAfterGetRecordForVendor(var VendLedgEntry1: Record "Vendor Ledger Entry")begin
    ...
    local procedure PrintOneLineOneEntryOnAfterGetRecordForEmployee(var EmployeeLedgerEntry1: Record "Employee Ledger Entry")begin
    ...
    local procedure CheckGLEntriesForEmployee(var EmployeeLedgerEntry3: Record "Employee Ledger Entry")begin
    ...
    local procedure CheckGLEntriesForCustomers(var CustLedgEntry3: Record "Cust. Ledger Entry")begin
    ...
    local procedure CheckGLEntiresForVendors(var VendLedgEntry3: Record "Vendor Ledger Entry")begin
