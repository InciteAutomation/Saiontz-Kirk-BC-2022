report 50171 REP_ChecksForWellsFargoEscrow
{
    CaptionML = ENU='Wells Fargo Check Report';
    RDLCLayout = 'ReportLayouts/WellsFargoChecReportEscrow.rdl';
    WordLayout = 'ReportLayouts/WellsFargoChecReportEscrow.docx';
