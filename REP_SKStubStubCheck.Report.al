report 50101 REP_SKStubStubCheck
{
    CaptionML = ENU='SK Stub/Stub/Check Layout';
    RDLCLayout = 'ReportLayouts/SKStubStubCheck.rdl';
    WordLayout = 'ReportLayouts/SKStubStubCheck.docx';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine;"Gen. Journal Line")
        {
            ...
            column("Shortcut_Dimension_Code";"ShortcutDimensionCode")
            {
            }
            // column("Shortcut_Dimension_Code"; "Shortcut Dimension 2 Code") { }
            ...
            dataitem(CheckPages;"Integer")
            {
                ...
                dataitem(PrintSettledLoop;"Integer")
                {
                    ...
                    trigger OnAfterGetRecord()begin
                        ...
                        ShortcutDimensionCode:=GenJnlLine."Shortcut Dimension 2 Code";
                        if not TestPrint then begin
                            if FoundLast or not AddedRemainingAmount then begin
                                if RemainingAmount <> 0 then begin
                                    ...
                                    LineDiscount:=0;
                                    RemainingAmount:=0;
                                    ShortcutDimensionCode:=CheckToAddr[2];
                                ...
                                ApplyMethod::MoreLinesOneEntry: begin
                                    ...
                                    if GenJnlLine2."Applies-to Doc. No." = '' then begin
                                        ...
                                        ShortcutDimensionCode:=GenJnlLine2."Shortcut Dimension 2 Code";
                                    end
                                    else
    ...
    ShortcutDimensionCode: Text[100];
    ...
    RemainingAmount2: Decimal)begin
        ...
        ShortcutDimensionCode:=CustLedgEntry2."Global Dimension 2 Code";
    ...
    RemainingAmount2: Decimal)begin
        ...
        ShortcutDimensionCode:=VendLedgEntry2."Global Dimension 2 Code";
    ...
    RemainingAmount2: Decimal)begin
        ...
        ShortcutDimensionCode:=EmployeeLedgerEntry2."Global Dimension 2 Code";
