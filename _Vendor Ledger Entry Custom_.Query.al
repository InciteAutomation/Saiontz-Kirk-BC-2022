query 50130 "Vendor Ledger Entry Custom"
{
    caption = 'Vendor Ledger Entries Custom';
    ...
    column(Debit_Amount_LCY;
    "Debit Amount (LCY)")
    {
    }
    column(Credit_Amount_LCY;
    "Credit Amount (LCY)")
    {
    }
