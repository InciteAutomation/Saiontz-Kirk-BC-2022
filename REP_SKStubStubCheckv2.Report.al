report 50102 REP_SKStubStubCheckv2
{
    CaptionML = ENU='SK Stub/Stub/Check Layout';
    RDLCLayout = 'ReportLayouts/SKStubStubCheckv2.rdl';
    WordLayout = 'ReportLayouts/SKStubStubCheckv2.docx';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine;"Gen. Journal Line")
        {
            ...
            //TODO add amount column and find right number
            //TODO add multiple lines in form
                        ...
                        if not TestPrint then begin
                            if FoundLast or not AddedRemainingAmount then begin
                                if RemainingAmount <> 0 then begin
                                    ...
                                    ShortcutDimensionCodeTable:=GenJnlLine."Shortcut Dimension 2 Code" end
                                else
                                    CurrReport.Break;
                            end
                            else
                                ...
                                ApplyMethod::MoreLinesOneEntry: begin
                                    ...
                                    if GenJnlLine2."Applies-to Doc. No." = '' then begin
                                        ...
                                        case BalancingType of BalancingType::"G/L Account": begin
                                            ...
                                            LineDiscount:=0;
                                            PostingDesc:=GenJnlLine2.Description;
                                            ShortcutDimensionCodeTable:=GenJnlLine2."Shortcut Dimension 2 Code" end;
